...
const Hvac = () => {
  return (
    <Template
      ...
      stat1={{number: '4-6%', text: 'Attrition before channel 80/20'}}
      stat2={{number: '10%', text: 'Of their direct sales are through MMC sales process'}}
      stat3={{number: '2nd', text: 'Highest annual sales volume amongst national distribution and legacy resellers'}}
      ...
      &nsbp;covered by direct sales team nor resellers including national account locations, buying groups and property owners."
