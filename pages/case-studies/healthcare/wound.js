...
const Wound = () => {
  return (
    <Template
      ...
      the month before. The virtual in-services have also received a 97% customer satisfaction rate, with customers saying the experience was ‘interactive’, ‘easy to understand’, and ‘engaging'."
    />
  );
}
