  ...
  return (
    <Meta>
      ...
      <Container className="text-center bg-info mt-5 p-5">
        <h5 class="eyebrow font-weight-bold text-uppercase pt-3">CHANNEL 80/20</h5>
        <h1 className="h2 font-weight-bold text-primary">
          MMC's Core Technologies <br />
          Explained
        </h1>
        <div style={{ maxWidth: 650 }} className="mx-auto">
          ...
          <p>
            The best part is we do it with <strong>your existing data.</strong>  There's no investment in technology or platforms,
