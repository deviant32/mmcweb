    ...
    <footer className="page-footer font-small bg-dark pt-4 text-white text-uppercase">
      <Container fluid className="text-center text-md-left pt-5 pb-5 pl-3 pr-3">
        <Row className="pl-md-5">
          ...
          <Col md="3" className="mb-md-0 mb-3 text-white">
            <FontAwesomeIcon style={{ marginRight: 10 }} size="lg" icon={['fab', 'facebook-f']} />
            <FontAwesomeIcon style={{ marginRight: 10 }} size="lg" icon={['fab', 'twitter']} />
            <FontAwesomeIcon style={{ marginRight: 10 }} size="lg" icon={['fab', 'linkedin-in']} />
          </Col>
        </Row>
      </Container>
